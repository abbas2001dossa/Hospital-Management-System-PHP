...
<body>
    ...
    <div id="title" style="margin-top:300px; border: 2px solid grey ;">
        ...
        <span style="font-size:45px; margin-top:2px;"><b><i> Login FORM  </i></b></span>
    </div>
		...
		<div class="section-center">
			<div class="container">
				<div class="row">
					<div class="booking-form">
						<div class="form-header">
							<h1 style="color:orange; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);"> Login   </h1>
						</div>
              ...
              <div class="form-group designation" >
                  ...
                  <input name="patient" value="patient" id="patient" name="patient" type="checkbox"  style="color:black;">                
                </div>
                <div id="adminD">
                  <label for=""> ADMIN </label>
                  <input type="checkbox" name="admin" value="admin" id="admin" value="admin">
                </div>
                <div id="doctorD">
                  <label for=""> DOCTOR </label>
                  <input type="checkbox" name="doctor" value="doctor" id="doctor" value="doctor">
                </div>
              </div>
                            
                
							<div class="form-group mt-5" style="color:black;">
								<input class="fc" id="name" name="name" type="text" placeholder="Name :" style="color:black; margin-top:50px;">
							</div>
              <div class="form-group mt-5" style="color:black;">
								<input class="fc" id="userId" name="userId" type="text" placeholder="User Id " style="color:black;">
							</div>
              <div class="form-group" style="color:black;">
								<input class="fc" type="password" id="pass" name="pass" placeholder="Password :  "style="color:black;">
							</div>

                            
							<div class="form-btn">
								<a><button type="submit" id="submit" name="submit" class="submit-btn">Login Now</button> </a> 
							</div>
						</form>
					</div>
				</div>
...
<?php
    ...
    if ( isset($_POST['submit'])){
        ...
        $pass = $_POST['pass'];
        $search ="";
        $sql2 = "SELECT * FROM users WHERE userId LIKE '%".$search."%'";

        if(isset($_POST['patient'])){
          $search = "PAT"; // search term
            ...
            if ( $_POST['userId'] == $row['userId'] )
            {
              ...
              else
              {
                ...
                '<script>
                    ...
                    alert.innerHTML = " WARNING : INCORRECT PASSWORD !";
